...
plt.scatter(Center_filtered, Power_filtered, color='#FFC0CB', label='Measured Data',s=10)
plt.plot(x_fit, y_fit, color='#038554', label=f'Gaussian Curve Fitting: A={A:.2f}, μ={mu:.2f}, σ={sigma:.2f}, c={const:.2f}', linewidth=3)
